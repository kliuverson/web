...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // ── Actualizar correo y teléfono en hero ──
  ...
  // ── Actualizar campos de info personal ──
  const setVal = (id, val) => {
  ...
  setVal('val-fecha', usuario.fecha_nacimiento);
  ...
  if (btnGuardar) {
    btnGuardar.addEventListener('click', async () => {
      ...
      try {
        ...
        if (res.ok) {
          // Actualizar storage con nuevos datos
          ...
          setVal('val-fecha', datos.fecha_nacimiento);
